...
Eq.~\ref{GPS:eq:v} gives the relation how the ice velocity $v_{year}$ has been calculated from the corrected stake positions in
...
Eq.~\ref{GPS:eq:sv} shows how the error on $v_{year}$ has been obtained.
...
(Tab~\ref{GPS:tab:errors}) were used.
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.88\textwidth]{./figs/T1_2d.pdf}
