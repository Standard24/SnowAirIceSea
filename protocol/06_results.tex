...
\hline
	$B(T=0\°)$ & $4.51 \cdot 10^{-8}$ & $5.61 \cdot 10^{-2}$ & $2.07$ \\
\hline
	$B(T=-5\°)$ & $1.18 \cdot 10^{-8}$ & $1.47 \cdot 10^{-2}$ & $5.43 \cdot 10^{-1}$ \\
\hline
	$B(T=-10\°)$ & $3.63 \cdot 10^{-9}$ & $4.51 \cdot 10^{-3}$ & $1.17 \cdot 10^{-1}$ \\
\hline
	$B(T=-15\°)$ & $2.17 \cdot 10^{-9}$ & $2.71 \cdot 10^{-3}$ & $9.98 \cdot 10^{-2}$
	\end{tabular}

	\begin{tabular}{c|c|c|c}
	$\alpha=6\°$ & $H_{min} = 1$ & $H_{avg}=33.4$ & $H_{max} = 82.3$ \\
\hline
	$B(T=0\°)$ & $7.78 \cdot 10^{-8}$ & $9.68 \cdot 10^{-2}$ & $3.57$ \\
\hline
	$B(T=-5\°)$ & $2.04 \cdot 10^{-8}$ & $2.54 \cdot 10^{-2}$ & $9.37 \cdot 10^{-1}$ \\
\hline
	$B(T=-10\°)$ & $6.26 \cdot 10^{-9}$ & $7.79 \cdot 10^{-3}$ & $2.87 \cdot 10^{-1}$ \\
\hline
	$B(T=-15\°)$ & $3.75 \cdot 10^{-9}$ & $4.67 \cdot 10^{-3}$ & $1.72 \cdot 10^{-1}$
	\end{tabular}

	\begin{tabular}{c|c|c|c}
	$\alpha=7\°$ & $H_{min} = 1$ & $H_{avg}=33.4$ & $H_{max} = 82.3$ \\
\hline
	$B(T=0\°)$ & $1.23 \cdot 10^{-7}$ & $1.53 \cdot 10^{-1}$ & $5.66$ \\
\hline
	$B(T=-5\°)$ & $3.24 \cdot 10^{-8}$ & $4.03 \cdot 10^{-2}$ & $1.49$ \\
\hline
	$B(T=-10\°)$ & $9.92 \cdot 10^{-9}$ & $1.23 \cdot 10^{-2}$ & $4.55 \cdot 10^{-1}$ \\
\hline
	$B(T=-15\°)$ & $5.95 \cdot 10^{-9}$ & $7.40 \cdot 10^{-3}$ & $2.73 \cdot 10^{-1}$
	\end{tabular}
    \caption{Theoretical surface velocities $u_\circledS\,\left[\fraction{m}{\text{yr}}\right]$, $\alpha = \{5\°,6\°,7\° \}$}
	\label{theorytable}
\begin{center}
...
Ice viscosity $\left[\fraction{P}{\text{yr}^{-3}}\right]$ & 55228873.88370403 & 86255041.2390786 & 1.27950949e8 & 1.51747996e8
\hline
\end{tabular}
\end{center}