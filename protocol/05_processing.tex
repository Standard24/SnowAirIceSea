...
If a solution is successfully find it is defined as 'fixed'.
...
By mistake a wrong fixed value can be hold, which can lead to an abnormal high position error due to an incorrect set of integer ambiguities.
...
Then the correction is different for the northing and easting. The northing correction is calculated with the cosinus of the direction of the inclination $\phi$. 
